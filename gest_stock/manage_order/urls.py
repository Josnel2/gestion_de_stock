...
from .views import ProductListCreateView, ProductDetailView,ProviderListCreateView, ProviderDetailView,OrderDetailView,OrderListCreateView,StatistiquesAPIView, ProduitsLesPlusVendusAPIView
